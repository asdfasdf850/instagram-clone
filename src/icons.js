...
export const SaveIcon = props => (
  <svg aria-label='Save' className='_8-yf5' fill='#262626' height={24} viewBox='0 0 48 48' width={24} {...props}>
...
export const CommentIcon = props => (
  <svg aria-label='Comment' className='_8-yf5' fill='#262626' height={24} viewBox='0 0 48 48' width={24} {...props}>
    <path
      clipRule='evenodd'
...
export const ExploreActiveIcon = props => (
  <svg aria-label='Find People' className='_8-yf5' fill='#262626' height={22} viewBox='0 0 48 48' width={22} {...props}>
    <path
      clipRule='evenodd'
...
export const HomeActiveIcon = props => (
  <svg aria-label='Home' className='_8-yf5' fill='#262626' height={22} viewBox='0 0 48 48' width={22} {...props}>
...
export const LikeIcon = props => (
  <svg aria-label='Like' className='_8-yf5' fill='#262626' height={24} viewBox='0 0 48 48' width={24} {...props}>
    <path
      clipRule='evenodd'
...
export const RemoveIcon = props => (
  <svg aria-label='Remove' className='_8-yf5' fill='#262626' height={24} viewBox='0 0 48 48' width={24} {...props}>
...
export const ShareIcon = props => (
  <svg aria-label='Share Post' className='_8-yf5' fill='#262626' height={24} viewBox='0 0 48 48' width={24} {...props}>
...
export const UnlikeIcon = props => (
  <svg aria-label='Unlike' className='_8-yf5' fill='#ed4956' height={24} viewBox='0 0 48 48' width={24} {...props}>
    <path
      clipRule='evenodd'
...
export const GearIcon = props => (
  <svg aria-label='Options' className='_8-yf5' fill='#262626' height={24} viewBox='0 0 48 48' width={24} {...props}>
    <path
      clipRule='evenodd'
...
export const CloseIcon = props => (
  <svg aria-label='Close' className='_8-yf5' fill='#fff' height={24} viewBox='0 0 48 48' width={24} {...props}>
    <path
      clipRule='evenodd'
...
export const AddIcon = props => (
  <svg aria-label='New Post' className='_8-yf5' fill='#262626' height={22} viewBox='0 0 48 48' width={22} {...props}>
...
export const GridIcon = props => (
  <svg aria-label='Posts' className='_8-yf5' fill='#999' height={24} viewBox='0 0 48 48' width={24} {...props}>
    <path
      clipRule='evenodd'
