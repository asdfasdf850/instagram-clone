...
export default function ProfileTabs({ user, isOwner }) {
      ...
      <section className={classes.section}>
        ...
        <Hidden smUp>
          <Tabs
            ...
            classes={{ indicator: classes.tabsIndicator }}
          >
            <Tab icon={<GridIcon fill={value === 0 ? '#3897f9' : undefined} />} classes={{ root: classes.tabRoot }} />
            {isOwner && (
              <Tab icon={<SaveIcon fill={value === 1 ? '#3897f9' : undefined} />} classes={{ root: classes.tabRoot }} />
            )}
          </Tabs>
        </Hidden>
