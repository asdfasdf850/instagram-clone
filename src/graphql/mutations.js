...
export const CREATE_POST = gql`
  mutation createPost($userId: uuid!, $mediaUrl: String!, $location: String!, $caption: String!) {
    insert_posts(objects: { user_id: $userId, media: $mediaUrl, location: $location, caption: $caption }) {
      affected_rows
    }
  }
`
...
export const UNFOLLOW_USER = gql`
  mutation unfollowUser($userIdToFollow: uuid!, $currentUserId: uuid!) {
    ...
    delete_notifications(
      where: { user_id: { _eq: $currentUserId }, profile_id: { _eq: $userIdToFollow }, type: { _eq: "follow" } }
    ) {
      affected_rows
    }
  }
